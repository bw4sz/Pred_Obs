...
```{r,fig.height=5}
nicheWCplot<-sim(trx,size=10,breadth=40,signalFlag=F,repulse=T,replicates=50,multiplot=T)
...
```{r,fig.height=5}
nicheCplot<-sim(trx,size=10,breadth=40,signalFlag=T,repulse=T,replicates=50,multiplot=T,ylm=c(0,1)) + ggtitle("Strong Phylogenetic Signal and Repulsion in Occurance Trait")
nicheCplot
```
...
```{r,fig.height=5}
nicheWCNRplot<-sim(trx,size=10,breadth=40,signalFlag=F,repulse=F,replicates=50,multiplot=T)
...
nicheCNRplot<-sim(trx,size=10,breadth=40,signalFlag=T,repulse=F,replicates=50,multiplot=T)
...
```{r,fig.height=6}
trees(sp=16,type="balanced",size=20,breadth=40,replicates=50,ylm=c(0,.6)) 
```

###Ladder

```{r,fig.height=6}
trees(sp=16,type="left",size=20,breadth=40,replicates=50,ylm=c(0,.6)) 
```
...
```{r,fig.height=5}
trees(sp=32,type="balanced",size=20,breadth=40,replicates=50,ylm=c(0,.6)) 
```

###Ladder

```{r,fig.height=6}
trees(sp=32,type="left",size=20,breadth=40,replicates=50,ylm=c(0,.6)) 
```
