...
```{r,fig.height=10}
sim.func<-function(){scape(trx, scape.size=7, g.center=1.1, g.range=1.1, g.repulse=10, wd.all=15, signal.center=TRUE, signal.range=FALSE, same.range=TRUE, repulse=TRUE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
...
```{r,fig.height=10}
sim.func<-function(){scape(trx, scape.size=7, g.center=1.1, g.range=1.1, g.repulse=5, wd.all=20, signal.center=TRUE, signal.range=FALSE, same.range=TRUE, repulse=TRUE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
...
```{r,fig.height=10}
sim.func<-function(repulse,signal){scape(trx, scape.size=7, g.center=signal, g.range=1, g.repulse=repulse, wd.all=5, signal.center=TRUE, signal.range=FALSE, same.range=TRUE, repulse=TRUE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
