...
mod1<-sim(trx,size=10,breadth=40,signalFlag=F,repulse=T,replicates=50,multiplot=F,plotR=F)

mod2<-sim(trx,size=10,breadth=40,signalFlag=T,repulse=T,replicates=50,plotR=F,ylm=c(0,1)) 

mod3<-sim(trx,size=10,breadth=40,signalFlag=F,repulse=F,replicates=50,plotR=F)

mod4<-sim(trx,size=10,breadth=40,signalFlag=T,repulse=F,replicates=50,plotR=F)
