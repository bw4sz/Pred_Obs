...
sim.func<-function(){scape(trx, scape.size=7, g.center=1, g.range=1, g.repulse=1, wd.all=5, signal.center=FALSE, signal.range=FALSE, same.range=TRUE, repulse=FALSE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
...
sim.func<-function(){scape(trx, scape.size=10, g.center=1.5, g.range=1.5, g.repulse=1, wd.all=20, signal.center=TRUE, signal.range=TRUE, same.range=TRUE, repulse=FALSE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
...
```{r,fig.height=10}
sim.func<-function(){scape(trx, scape.size=10, g.center=2, g.range=2, g.repulse=5, wd.all=20, signal.center=TRUE, signal.range=FALSE, same.range=TRUE, repulse=TRUE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}

sim.list<-replicate(30,sim.func(),simplify=FALSE)
...
```{r,fig.height=10}
sim.func<-function(){scape(trx, scape.size=10, g.center=5, g.range=1, g.repulse=5, wd.all=20, signal.center=TRUE, signal.range=FALSE, same.range=TRUE, repulse=TRUE,center.scale = 1, range.scale = 1, repulse.scale = 1, site.stoch.scale = 0, sd.center=1, sd.range=1,rho=NULL, th=th)}
