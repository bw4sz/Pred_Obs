...
~1+linear+quad+(1+linear+quad|species)
mod2<-glmer(data=l[,],formula = as.factor(P_A) ~ poly(Phylo.Relatedness,2,raw=T) + (poly(Phylo.Relatedness,2,raw=T)|Species), family = "binomial")
smod2<-summary(mod2)
smod2
