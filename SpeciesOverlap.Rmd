...
runsl<-rep(2000,4000,2000,5000,5000,5000,5000)
...
#parall<-list()
parall<-foreach(x=1:length(sdat),.errorhandling="stop") %do% {
#for(x in 1:length(sdat)){
  out<-Bayes(presence=sdat[[x]]$P_A,distance=sdat[[x]]$Phylo.Relatedness,species=sdat[[x]]$Species,Iteration=sdat[[x]]$Iteration,runs =runsl[x],burn=((runsl[x]/25)-2000),hier=modhier[x])
  return(out)
  #parall[[x]]<-out
}
#stopCluster(cl)
