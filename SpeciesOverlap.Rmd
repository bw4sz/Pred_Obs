...
runsl<-rep(100000,100000,100000,100000,100000,100000,100000)
...
#for(x in 1:length(sdat)){
  out<-Bayes(presence=sdat[[x]]$P_A,distance=sdat[[x]]$Phylo.Relatedness,species=sdat[[x]]$Species,runs = runsl[x],burn=((runsl[x]/nt)-2000),hier=modhier[x])
  return(out)
  #parall[[x]]<-out
}
stopCluster(cl)
