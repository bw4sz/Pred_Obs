...
p<-p + geom_jitter(data=pts,aes(x=Phylo.Relatedness,y=P_A,size=Assemblages,alpha=Assemblages),position = position_jitter(width = .005,height=0)) + scale_size_continuous(range=c(2,4)) + scale_alpha(range=c(0.4,0.7))
p
