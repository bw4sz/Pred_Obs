...
system.time(all_models<-foreach(x=1:nlayers(modlist),.export=c("sp.lists","siteXspp.raster","pred_realized","fold","gitpath","cellSitesXY","costThresh","CostPathMatrix"),.errorhandling="stop",.packages=c("raster","maptools","reshape2","dismo","picante","ggplot2","rasterVis","lattice")) %dopar%{
...
system.time(all_modelsDD<-foreach(x=1:nlayers(modlist),.errorhandling="stop",.export=c("sp.lists","siteXspp.raster","pred_realized","fold","gitpath","cellSitesXY","costThresh","CostPathMatrix"),.packages=c("raster","maptools","reshape2","dismo","picante","ggplot2","rasterVis","lattice")) %dopar%{ 
...
PA_m2<-predAssemblages(thresh=.2,plots=TRUE)
```
